...
export const objMockData = [{
    ...
    targetProperties:
    {
        justifyContent: getRandomItemFromArray(propertiesValueStrings.justifyContent),
        alignItems: getRandomItemFromArray(propertiesValueStrings.alignItems),
        flexDirection: getRandomItemFromArray(propertiesValueStrings.flexDirection)
    },
    userProperties:
    {
        justifyContent: getRandomItemFromArray(propertiesValueStrings.justifyContent),
...
// TODO :1) flex-direction : row / column,row-reverse, column-reverse
